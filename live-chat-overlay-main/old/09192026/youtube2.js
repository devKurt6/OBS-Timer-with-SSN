...
if (data.sticker) {
    ...
    <div class="donation donation-icon-label" style="position:absolute;display:block;text-align:center;left:10px;top:108px;z-index:3;min-width:175px;border-radius:10px;padding:30px 5px 0;overflow:hidden;transform:rotate(-5deg) translateX(-50%);${scCardBg}">
        <div
            style="
                position:absolute;
                top:0;
