...
if (data.sticker) {
    ...
    var scShine = data.tierColor ? 'color-mix(in srgb, '+data.tierColor+' 25%, white)' : '#fff';
    var scTopGrad = data.tierColor
      ? 'background:linear-gradient(270deg, '+scTopColor+' 0%, '+scShine+' 49%, '+scTopColor+' 100%);'
      : 'background:rgba(0,0,0,.25);';
    var scBottomGrad = data.tierColor
      ? 'background:linear-gradient(270deg, '+scBottomColor+' 0%, '+scShine+' 49%, '+scBottomColor+' 100%); padding:2px 5px; border-radius:0 0 8px 8px;'
      : '';
    var scCardBg = data.tierColor
      ? 'background:linear-gradient(270deg, '+scBottomColor+' 0%, '+scShine+' 49%, '+scBottomColor+' 100%);'
      : '';
    ...
    <div class="donation donation-icon-label" style="${scCardBg}">
        <div
            style="
                ...
                ${scTopGrad}
                border-radius:10px 10px 0 0;
                color:var(--donation-label-color, #fffafa);
                z-index:2;
                display:flex;
                align-items:center;
                justify-content:center;
